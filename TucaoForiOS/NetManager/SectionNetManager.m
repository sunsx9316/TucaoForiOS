...
+ (NSURLSessionDataTask *)sectionListWithId:(NSString *)Id
    ...
    return [self GETDataWithPath:[NSString stringWithFormat:@"http://www.tucao.tv/api_v2/list.php?tid=%@&page=%lu&pagesize=21&apikey=25tids8f1ew1821ed&date=0", Id, page] parameters:nil completionHandler:^(NSData *responseObj, TucaoErrorModel *error) {
